...
function myGroupView() {
    ...
    removeOptions(document.getElementById('myFriendList'));
     ...
     if (xGroupValue == "1") {
            ...
            appendNewOption(1, "1 Austin's birthday is October 2")
            appendNewOption(2, "2 Ayla B's birthday is November 11-Poppy Day")
            appendNewOption(3, "3 Charlotte's birthday is April 6")
            appendNewOption(4, "4 Chloe B's birthday is December 1")
            appendNewOption(5, "5 Chloe L's birthday is March 23")
            appendNewOption(6, "6 Ellanora's birthday is August 22 ")
            appendNewOption(7, "7 Ella's birthday is August 6")
            appendNewOption(8, "8 Georgena's birthday is April 7")
            appendNewOption(9, "9 Hedley's birthday is August 9")
            appendNewOption(10, "10 Isabel's birthday is May 7")
            appendNewOption(11, "11 Isla H's birthday is August 2")
            appendNewOption(12, "12 Julien's birthday is September 26")
            appendNewOption(13, "13 Lochlan's birthday is October 4")
            appendNewOption(14, "14 Maisie's birthday is October 23")
            appendNewOption(15, "15 Paul's birthday is May 28")
            appendNewOption(16, "16 Remy's birthday is March 14")
            appendNewOption(17, "17 Matteo's birthday is February 11")
            appendNewOption(18, "18 Lucas's birthday is August 23")
