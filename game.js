...
function myGroupView() {
    ...
    removeOptions(document.getElementById('myFriendList'));
     ...
     if (xGroupValue == "1") {
            ...
            appendNewOption(1, "Austin's birthday is Oct 2")
            appendNewOption(2, "Ayla B")
            appendNewOption(3, "Charlotte")
            appendNewOption(4, "Chloe B")
            appendNewOption(5, "Chloe L")
            appendNewOption(6, "Ellanora")
            appendNewOption(7, "Ella")
            appendNewOption(8, "Georgena")
            appendNewOption(9, "Hedley")
            appendNewOption(10, "Isabel")
            appendNewOption(11, "Illa H")
            appendNewOption(12, "Julien")
            appendNewOption(13, "Lochlan")
            appendNewOption(14, "Maisie")
            appendNewOption(15, "Paul")
            appendNewOption(16, "Remy")
            appendNewOption(17, "Matteo")
