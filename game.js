...
function myGroupView() {
    ...
    removeOptions(document.getElementById('myFriendList'));
     ...
     if (xGroupValue == "1") {
            ...
            appendNewOption(1, "Austin's birthday is October 2")
            appendNewOption(2, "Ayla B's birthday is November 11-Poppy Day")
            appendNewOption(3, "Charlotte's birthday is April 2")
            appendNewOption(4, "Chloe B's birthday is December 1")
            appendNewOption(5, "Chloe L")
            appendNewOption(6, "Ellanora")
            appendNewOption(7, "Ellia")
            ...
            appendNewOption(15, "Paul's birthday is April 23")
            appendNewOption(16, "Remy")
            appendNewOption(17, "Matteo's birthday is February 23")
            appendNewOption(18, "Lucas")
