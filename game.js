...
function myGroupView() {
    ...
    if (xGroupValue == "3") {
     ...
     if (xGroupValue == "7") {
            ...
            appendNewOption(2,"Arizona Cardinals")
            appendNewOption(3,"Atlanta Falcons")
            appendNewOption(4,"Baltimore Ravens")
            appendNewOption(5,"Buffalo Bills")
            appendNewOption(6,"Carolina Panthers")
            appendNewOption(7,"Chicago Bears")
            appendNewOption(8,"Cincinnati Bengals")
            appendNewOption(9,"Cleveland Browns")
            appendNewOption(10,"Dallas Cowboys")
            appendNewOption(11,"Denver Broncos")
            appendNewOption(12,"Detroit Lions")
            appendNewOption(13,"Green Bay Packers")
            appendNewOption(14,"Houston Texans")
            appendNewOption(15,"Indianapolis Colts")
            appendNewOption(16,"Jacksonville Jaguars")
            appendNewOption(17,"Kansas City Chiefs")
            appendNewOption(18,"Las Vegas Raiders")
            appendNewOption(19,"Los Angeles Chargers")
            appendNewOption(20,"Los Angeles Rams")
            appendNewOption(21,"Miami Dolphins")
            appendNewOption(22,"Minnesota Vikings")
            appendNewOption(23,"New England Patriots")
            appendNewOption(24,"New Orleans Saints")
            appendNewOption(25,"New York Giants")
            appendNewOption(26,"New York Jets")
            appendNewOption(27,"Philadelphia Eagles")
            appendNewOption(28,"Pittsburgh Steelers")
            appendNewOption(29,"San Francisco 49ers")
            appendNewOption(30,"Seattle Seahawks")
            appendNewOption(31,"Tampa Bay Buccaneers")
            appendNewOption(32,"Tennessee Titans")
            appendNewOption(33,"Washington Commanders")
