...
function myGroupView() {
  ...
  if (xGroupValue == "300") {
    ...
    appendNewOption(2, "Christian R")
    appendNewOption(3, "Clark K")
    appendNewOption(4, "Cloe L")
    appendNewOption(5, "Elisa")
    appendNewOption(6, "Emma")
    appendNewOption(7, "Gaby")
    appendNewOption(8, "Graham C")
    appendNewOption(9, "Helen R")
    appendNewOption(10, "James")
    appendNewOption(11, "Lendon L")
    appendNewOption(12, "Liam")
    appendNewOption(13, "Lily F")
    appendNewOption(14, "Lucas R")
    appendNewOption(15, "Luciana")
    appendNewOption(16, "Mable")
    appendNewOption(17, "Matteo B")
    appendNewOption(18, "Maya")
    appendNewOption(19, "Paul M")
    appendNewOption(20, "Remy P")
    appendNewOption(21, "Ronan")
    appendNewOption(22, "Seraphina")
    appendNewOption(23, "Stella")
    appendNewOption(24, "William B")
    appendNewOption(25, "Teacher Ms. Ku")
  ...
  if (xGroupValue == "210") {
    ...
    appendNewOption(4, "Nolan(7)")
    appendNewOption(5, "Sophia")
    appendNewOption(6, "Brice(3)")
    appendNewOption(7, "Hudson(5)")
    appendNewOption(8, "Dart")
    appendNewOption(9, "Henry")
    appendNewOption(10, "Wyat")
    appendNewOption(11, "Alise")
    appendNewOption(12, "Atlas")
    appendNewOption(13, "Jane")
    appendNewOption(14, "Kane")
    appendNewOption(15, "Karen")
    appendNewOption(16, "Aila")
    appendNewOption(17, "Camelet(v)")
    appendNewOption(18, "Pearson(v)")
    appendNewOption(19, "Gary(i)")
